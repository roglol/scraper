...
<!-- Mirrored from demo.canyonthemes.com/html/canyonmag/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Mar 2020 15:44:48 GMT -->
<head>
    <meta charset="utf-8">
	            ...
	            <div class="col-sm-3 col-md-3">
	            	<div class="sidebar-col">
		                <div class="sidebar-box add wow animated fadeInUp" data-wow-delay="0.2s">
		                    <a href="https://www.templatesell.com/item/quality-construction-pro-wordpress-themes/" target="blank">
		                    	<img src="img/ad/ad.jpg" class="img-responsive" alt=""> 
		                    </a>
		                    ...
		                    <div class="side-tabs">
		                        ...
		                        <div class="tab-content">
		                            <div role="tabpanel" class="tab-pane active" id="home">
		                                <div class="media">
		                                    <div class="media-left">
		                                        <a href="#"> <img class="media-object" src="img/avtar-1.jpg" width="60" alt="..."> </a>
		                                    </div>
		                                    <div class="media-body">
		                                        <h4 class="media-heading"><a href="#">Maecenas mauris elementum, est morbi</a></h4> <span>By John</span> </div>
		                                </div>
		                                <!--media-->
		                                <div class="media">
		                                    <div class="media-left">
		                                        <a href="#"> <img class="media-object" src="img/avtar-2.jpg" width="60" alt="..."> </a>
		                                    </div>
		                                    <div class="media-body">
		                                        <h4 class="media-heading"><a href="#">Maecenas mauris elementum, est morbi</a></h4> <span>By John</span> </div>
		                                </div>
		                ...
		                <!--sidebar box-->
		                <div class="sidebar-box wow animated fadeInUp" data-wow-delay="1s">
		                    <h3>Twitter</h3>
		                    <ul class="list-unstyled twitter-feeds">
		                        <li> 
		                        	<span>Maecenas mauris elementum, <a href="#">@canyonthemes</a> interdum cursus at elite.</span> <em>2 Hours ago</em> 
		                        </li>
		                        <li> 
		                        	<span>Maecenas mauris elementum, <a href="#">@canyonthemes</a> interdum cursus at elite.</span> <em>2 Hours ago</em> 
		                        </li>
...
<!-- Mirrored from demo.canyonthemes.com/html/canyonmag/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Mar 2020 15:47:55 GMT -->
</html>